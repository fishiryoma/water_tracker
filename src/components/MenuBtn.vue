<template>
  <div class="flex justify-between max-w-[640px] mx-3 sm:mx-auto bg-primary-200/60 rounded-lg pl-2">
    <div class="flex gap-2 sm:gap-4">
      <RouterLink v-for="item in menu" :key="item.url" :to="item.url" v-slot="{ isActive }">
        <div
          :class="[
...
import { ChartBarSquareIcon, Cog6ToothIcon } from '@heroicons/vue/24/outline'
...
const menu = computed(() => [
  ...
  { url: '/setting', icon: Cog6ToothIcon, text: t('MENU.SETTING') },
])
</script>
